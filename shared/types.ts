...
export type TaskStatus = "backlog" | "plangenerating" | "ready" | "ralph" | "inprogress" | "qa" | "done" | "cancelled" | "idea" | "planning" | "specreview";
...
export type UpdatePlanningSession = { session_ref: string | null, notes: string | null, };
...
export type Workspace = { id: string, task_id: string, container_ref: string | null, branch: string, agent_working_dir: string | null, setup_completed_at: string | null, created_at: string, updated_at: string, archived: boolean, pinned: boolean, name: string | null, dev_url: string | null, };

export type WorkspaceWithStatus = { is_running: boolean, is_errored: boolean, id: string, task_id: string, container_ref: string | null, branch: string, agent_working_dir: string | null, setup_completed_at: string | null, created_at: string, updated_at: string, archived: boolean, pinned: boolean, name: string | null, dev_url: string | null, };

export type Session = { id: string, workspace_id: string, executor: string | null, created_at: string, updated_at: string, };

export type ExecutionProcess = { id: string, session_id: string, run_reason: ExecutionProcessRunReason, executor_action: ExecutorAction, status: ExecutionProcessStatus, exit_code: bigint | null, error_summary: string | null, 
/**
...
export type ExecutionProcessRunReason = "setupscript" | "cleanupscript" | "archivescript" | "codingagent" | "devserver" | "autoplan";
...
export type ApprovalResponse = { execution_process_id: string, status: ApprovalStatus, updated_input?: JsonValue, };
 ...
 */
stop_after_plan?: boolean | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
