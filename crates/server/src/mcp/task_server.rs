...
impl ServerHandler for TaskServer {
    fn get_info(&self) -> ServerInfo {
        ...
        if self.context.is_some() {
            let context_instruction = "Use 'get_context' to fetch project/issue/workspace metadata for the active Wicke Kanban workspace session when available.";
