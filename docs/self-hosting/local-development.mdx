...
description: "Run Wickeban Cloud locally"
---

This guide walks you through setting up a local Wickeban Cloud instance for development and testing.
...
3. Fill in the details:
   - **Application name**: Wickeban Local
...
Open [http://localhost:3000](http://localhost:3000) in your browser. You should see the Wickeban Cloud login page.
