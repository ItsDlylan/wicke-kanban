---
title: "Wickeban Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

<Note>
Wickeban Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is Wickeban Cloud?

**Wickeban Cloud** adds team collaboration to Wickeban. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Wickeban interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Wickeban installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Wickeban** as usual with `npx wickeban`
...
Think of it as your company or team in Wickeban.
...
- Review code directly in Wickeban
- Track PR status

## Getting Started

<Steps>
<Step title="Run Wickeban">
  ```bash
  npx wickeban
  ```
</Step>
