...
description: "Solutions for common issues with Wickeban Cloud"
---

This page covers common issues you might encounter with Wickeban Cloud and how to resolve them.
...
4. Return to Wickeban and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Wickeban (`npx wickeban`)
</Accordion>
...
1. **Check existing issues:** [github.com/BloopAI/wickeban/issues](https://github.com/BloopAI/wickeban/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/BloopAI/wickeban/issues/new">
