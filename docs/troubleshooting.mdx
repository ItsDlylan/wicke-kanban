...
description: "Common issues and solutions when using Wickeban"
---
...
If you encounter irrecoverable errors and need to completely wipe your Wickeban database, you can delete the application data directory for your operating system. 
...
<Tab title="macOS">
```bash
~/Library/Application Support/ai.bloop.wickeban/
```
</Tab>

<Tab title="Linux">
```bash
~/.local/share/wickeban/
```
</Tab>

<Tab title="Windows">
```
%APPDATA%\bloop\wickeban\
```

Typically: `C:\Users\<username>\AppData\Roaming\bloop\wickeban\`
</Tab>
</Tabs>

After deleting the application data directory, restart Wickeban to reset with an empty database and default settings.
