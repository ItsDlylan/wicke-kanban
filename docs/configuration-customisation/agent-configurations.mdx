...
<Info>
Agent profiles are used throughout Wickeban wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Wickeban saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Wickeban for your coding agents
</Card>

<Card title="Wickeban MCP Server" icon="plug" href="/integrations/wickeban-mcp-server">
  Connect external MCP clients to Wickeban's MCP server
</Card>
</CardGroup>
