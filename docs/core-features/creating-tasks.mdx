...
<Tip>
For detailed setup instructions and examples, see the [Wickeban MCP Server](/integrations/wickeban-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Wickeban project based on this description.
