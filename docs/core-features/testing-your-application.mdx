...
Preview Mode provides an embedded browser experience within Wickeban, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and Wickeban by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in Wickeban
...
<Step title="Install Web Companion">
  For precise component selection, install the `wickeban-web-companion` package in your application.

  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have Wickeban create a task that installs and configures the companion for you.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install wickeban-web-companion
  ```
...
3. **Interact with your app** directly within Wickeban
...
<Step title="Activate Selection Mode">
  Click the floating Wickeban companion button in the bottom-right corner of your application to activate component selection mode.
...
<Step title="Choose Component Depth">
  When you click a component, Wickeban shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise Wickeban settings
