...
description: "Learn how to complete tasks by rebasing, merging, and managing pull requests directly from Wickeban"
sidebarTitle: "Completing a Task"
---

When your task is finished, Wickeban provides integrated git operations to keep your branch up-to-date and merge your work back into the base branch.
