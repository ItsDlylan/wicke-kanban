...
<Step title="Authenticate with Factory AI">
  To use Droid in Wickeban, you must first authenticate:
...
Droid supports several configuration options in Wickeban:
...
These options can be configured when creating agent configurations in Wickeban.
