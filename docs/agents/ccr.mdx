...
## Authentication
Authenticate and configure CCR outside of Wickeban. Follow the instructions on the CCR GitHub repo:
...
Wickeban does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Wickeban

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Wickeban" />
</Frame>

## Using CCR in Wickeban
