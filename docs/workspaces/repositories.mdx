...
When you add a repository to a workspace, Wickeban creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.wickeban-workspaces` directory (configurable in Settings).
</Accordion>
