...
description: "Complete guide to all coding agents supported by Wickeban, including installation and authentication instructions"
---

Wickeban integrates with a variety of coding agents. Each agent requires installation and authentication before use. Select your preferred agent when creating task attempts.
